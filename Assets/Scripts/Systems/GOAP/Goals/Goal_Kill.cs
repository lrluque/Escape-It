...
public class Goal_Kill : Goal_Base
{
    [SerializeField] int KillPriority = 90;
    ...
    public override void OnTickGoal()
    {
        ...
        if (CurrentTarget != null)
        {
            ...
            foreach (var candidate in Sensors.ActiveTargets.Values)
            {
                ...
                {
                    CurrentPriority = candidate.Awareness < AwarenessToStopChase ? 0 : KillPriority;
                    return;
                }
            }
    ...
    public override bool CanRun()
    {
        ...
        foreach(var candidate in Sensors.ActiveTargets.Values)
        {
            if (candidate.Detectable != null && candidate.Awareness >= MinAwarenessToChase)
                return true;
        }
